...
resourcename="iajwei"  # lower case, only
resourcegroup="iajwei_rg"
...
# git clone https://github.com/apilogicserver/iajwei.git
# cd iajwei
...
az group create --name iajwei_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group iajwei_rg --sku S1 --is-linux
az container create --resource-group iajwei_rg --name iajwei --image apilogicserver/iajwei:latest --dns-name-label iajwei --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//iajwei.westus.azurecontainer.io:5656'
