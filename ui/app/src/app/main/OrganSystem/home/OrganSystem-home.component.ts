...
@Component({
  selector: 'OrganSystem-home',
  templateUrl: './OrganSystem-home.component.html',
  styleUrls: ['./OrganSystem-home.component.scss']
})
export class OrganSystemHomeComponent implements AfterViewInit {
