...
@Component({
  selector: 'Organism-home',
  templateUrl: './Organism-home.component.html',
  styleUrls: ['./Organism-home.component.scss']
})
export class OrganismHomeComponent implements AfterViewInit {
