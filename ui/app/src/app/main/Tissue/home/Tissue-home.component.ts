...
@Component({
  selector: 'Tissue-home',
  templateUrl: './Tissue-home.component.html',
  styleUrls: ['./Tissue-home.component.scss']
})
export class TissueHomeComponent implements AfterViewInit {
