...
@Component({
  selector: 'BloodVessel-home',
  templateUrl: './BloodVessel-home.component.html',
  styleUrls: ['./BloodVessel-home.component.scss']
})
export class BloodVesselHomeComponent implements AfterViewInit {
