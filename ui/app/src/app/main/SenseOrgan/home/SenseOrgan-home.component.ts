...
@Component({
  selector: 'SenseOrgan-home',
  templateUrl: './SenseOrgan-home.component.html',
  styleUrls: ['./SenseOrgan-home.component.scss']
})
export class SenseOrganHomeComponent implements AfterViewInit {
