...
@Component({
  selector: 'Muscle-home',
  templateUrl: './Muscle-home.component.html',
  styleUrls: ['./Muscle-home.component.scss']
})
export class MuscleHomeComponent implements AfterViewInit {
